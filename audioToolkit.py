...
def makeSofter(channel):  #makeSofter([0, -0.2, 0.4, -0.6])
    '''
this function will make the audio softer by 
    '''
    softList = []
    ...
    # TODO: Write me for loop

def chipmunk(channel):
    '''
CHIPMUNK MAKES AUDIO BITES SMALLER BY CUTTING THEM IN HAL FMAKING A CHIPMUNK SOUND EFFECT
    '''
    chipList = []
